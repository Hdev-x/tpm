...
function connectChat(symbol) {
    ...
    stompClient.connect({}, () => {
        stompClient.subscribe('/topic/market/COIN/' + symbol, msg => {
...
function appendChatMsg(username, content, createdAt, scroll, imageUrl, profileFileName, commentNo, likeCount, likedByMe) {
...
if (_chatMsgs) {
    ...
    _chatMsgs.addEventListener('click', e => {
        ...
        fetch('/api/market/comment/' + commentNo + '/like', { method: 'POST' })
            .then(r => r.json())
            .then(data => {
