    ...
    <div class="card" style="padding: 40px;">
        ...
        <form action="./update" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group">
                ...
                <input type="text" name="boardTitle" class="member-input" 
                       value="${detail.boardTitle}" style="width: 100%;">
            </div>

            <div class="input-group">
                <label class="input-label">작성자</label>
                <input type="text" name="boardWriter" class="member-input" 
                       value="${detail.boardWriter}" readonly style="width: 100%; opacity: 0.6; cursor: not-allowed;">
            </div>

            <div class="input-group">
                <label class="input-label">내용</label>
                <textarea name="boardContent" class="member-input" 
                          style="width: 100%; height: 250px; resize: none; line-height: 1.6; padding: 15px;">${detail.boardContent}</textarea>
            </div>
